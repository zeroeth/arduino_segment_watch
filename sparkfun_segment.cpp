...
int digit3 = A0; //PWM Display pin 6
int digit4 = A1; //PWM Display pin 8
...
void displayBuffer() {
#define DISPLAY_BRIGHTNESS  2200
...
#define DIGIT_OFF  LOW
  ...
  for(int digit = 4 ; digit > 0 ; digit--) {
    ...
    lightNumber(time_array[digit-1]);
    ...
    digitalWrite(mark, second_mark);

    delayMicroseconds(DISPLAY_BRIGHTNESS); //Display this digit for a fraction of a second (between 1us and 5000us, 500 is pretty good)
    
    digitalWrite(mark, DIGIT_OFF);
